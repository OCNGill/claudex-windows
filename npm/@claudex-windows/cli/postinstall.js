...
const PLATFORM_MAP = {
  'darwin-arm64': '@claudex-windows/darwin-arm64',
  'darwin-x64': '@claudex-windows/darwin-x64',
  'linux-x64': '@claudex-windows/linux-x64',
  'linux-arm64': '@claudex-windows/linux-arm64',
  'win32-x64': '@claudex-windows/windows-x64'
};

// Binary names to link
const BINARIES = ['claudex-windows', 'claudex-windows-hooks'];
...
function main() {
  ...
  console.log(`Installing claudex-windows for ${platformKey}...`);
...
`);
  ...
  console.log('\n✓ claudex-windows installed successfully!\n\nTry running: claudex-windows --help\n');
}
